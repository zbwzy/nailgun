...
from nailgun.common import sshexceptions as exceptions
...
class Client(object):
    ...
    def __init__(self, host, username, password=None, timeout=1800, pkey=None,
                 channel_timeout=300, look_for_keys=False, key_filename=None):
        self.host = host
