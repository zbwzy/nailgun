...
class Node(NailgunObject):
    ...
    @classmethod
    def get_by_mac_phymachine(cls, mac=None):
        phymachine=None
        if not mac:
            return phymachine
    ...
    def create(cls, data):
        ...
        * creating Notification about newly discovered Node \
        ...
        :returns: Node instance
        """
        logger.info(u'调用node.py中的create函数')
        ...
        cls.update_node_phymachine(data['mac'].lower())
    ...
    @classmethod
    def update_node_phymachine(cls, mac):
        phymachine=cls.get_by_mac_phymachine(mac)
        if phymachine:
    ...
    def update(cls, instance, data):
        ...
        * updating volumes allocation for Node using Cluster's Release \
        ...
        :returns: Node instance
        """
        logger.info(u'调用node.py中的update函数')
        data.pop("id", None)
